...
const {createMemory, getMemories, getMemory, deleteMemory, updateMemory, toggleFavorite, addComent} = require("./controllers/MemoryController");
...
router.patch("/comment/:id", (req, res) => addComent(req, res))
